...
TOP_LEVEL_NAME="amiga_clk_altera"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/net/numastore/software/local-linux-x86/altera/15.1.1.189/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/amiga_clk_altera.vo"
fi
