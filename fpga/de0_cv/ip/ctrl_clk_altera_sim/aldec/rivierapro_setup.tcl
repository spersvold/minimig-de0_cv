...
# ACDS 15.1 189 linux 2016.03.21.10:27:29
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If ctrl_clk_altera is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ctrl_clk_altera"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ctrl_clk_altera.vo"
}
