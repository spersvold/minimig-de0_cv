...
# ACDS 15.1 189 linux 2016.03.22.15:50:23
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If amiga_clk_altera is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "amiga_clk_altera"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/net/numastore/software/local-linux-x86/altera/15.1.1.189/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/amiga_clk_altera.vo"
}
